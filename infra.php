<?php
include "link.php";
$sel=mysqli_query($link,"select * from infra where id='1'");
...
$sel=mysqli_query($link,"select * from infra where id='2'");
while($arr=mysqli_fetch_array($sel))
{
	$t1=$arr['title'];
	$tx1=$arr['text'];
...
$sel=mysqli_query($link,"select * from infra where id='3'");
while($arr=mysqli_fetch_array($sel))
{
	$t2=$arr['title'];
	$tx2=$arr['text'];
...
$sel=mysqli_query($link,"select * from infra where id='4'");
while($arr=mysqli_fetch_array($sel))
{
	$t3=$arr['title'];
	$tx3=$arr['text'];
...
$sel=mysqli_query($link,"select * from infra where id='5'");
while($arr=mysqli_fetch_array($sel))
{
	$t4=$arr['title'];
	$tx4=$arr['text'];
...
$sel=mysqli_query($link,"select * from infra where id='6'");
while($arr=mysqli_fetch_array($sel))
{
	$t5=$arr['title'];
	$tx5=$arr['text'];
...
$sel=mysqli_query($link,"select * from infra where id='7'");
while($arr=mysqli_fetch_array($sel))
{
	$t6=$arr['title'];
	$tx6=$arr['text'];
	...
	<div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="index.php">Home</a><span class="crumbs-span">&raquo;</span><span>Infrastructure</span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
				...
				<div class="col-md-9 main-content">
							...
							<div class="blog-item single-post single-page">
								<div class="blog-img">
									<div class="bxslider-slide">
										<ul>
											<li><img alt="" src="images1/<?php echo $i1;?>" p style="width:100%!important; height:300px!important;"  ></li>
											<li><img alt="" src="images1/<?php echo $i2;?>"  p style="width:100%!important; height:300px!important;"></li>
                                            <li><img alt="" src="images1/img/slider/<?php echo $i3;?>" p style="width:100%!important;height:300px!important;" ></li>
										</ul>
									</div>
					...
					<?php echo $tx1;?>
                           ...
                           <div class="blog-content">
									...
									<div class="clearfix"></div>
									<div class="post-content">
										<p style="text-align:justify"><?php echo $tx2;?>
			</p>
									</div><!-- End post-content -->
									<div class="clearfix"></div>
								</div><!-- End blog-content -->
                            ...
                            <div class="blog-content">
									...
									<div class="clearfix"></div>
									<div class="post-content">
										<p style="text-align:justify"><?php echo $tx3;?></p>
                                ...
                                <div class="blog-content">
									...
									<div class="clearfix"></div>
									<div class="post-content">
										<p style="text-align:justify"><?php echo $tx4;?></p>
