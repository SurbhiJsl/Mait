...
$sel=mysqli_query($link,"select * from news where id='1'");
while($arr=mysqli_fetch_array($sel))
{
$tit1=$arr['title'];
$txt1=$arr['text'];
...
$sel=mysqli_query($link,"select * from news where id='2'");
while($arr=mysqli_fetch_array($sel))
{
$tit2=$arr['title'];
$txt2=$arr['text'];
...
$sel=mysqli_query($link,"select * from news where id='3'");
while($arr=mysqli_fetch_array($sel))
{
$tit3=$arr['title'];
$txt3=$arr['text'];
...
$sel=mysqli_query($link,"select * from news where id='4'");
while($arr=mysqli_fetch_array($sel))
{
$tit4=$arr['title'];
$txt4=$arr['text'];
...
$sel=mysqli_query($link,"select * from course where id='1'");
while($arr=mysqli_fetch_array($sel))
{
	$ttl1=$arr['title'];
	$sub1=$arr['subtitle'];
...
$sel=mysqli_query($link,"select * from course where id='2'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from course where id='3'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from course where id='4'");
while($arr=mysqli_fetch_array($sel))
{
...
<div id="wrap" class="grid_1200">
	...
	<header id="header">
		<div class="container clearfix">
			...
			<nav class="navigation">
				<ul>
					<li class="current_page_item"><a href="index.php"><?php echo $title1;?></a>
	...
	<div class="sections section-2">
		<div class="container">
			<div class="sections-title">
				<div class="sections-title-h3"><h3><?php echo $ttl1;?></h3></div>
					...
					<ul>
						<li>
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									<div class="portfolio-head">
										<div class="portfolio-img"><img alt="" src="images1/<?php echo $imm1;?>"></div>
										<div class="portfolio-hover">
											
											<a class="portfolio-zoom prettyPhoto" href="images1/<?php echo $imm1;?>"><i class="fa fa-search"></i></a>
										</div>
									</div><!-- End portfolio-head -->
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="btech.php"><?php echo $sub1;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									<div class="portfolio-head">
										<div class="portfolio-img"><img alt="" src="images1/<?php echo $imm2;?>"></div>
										<div class="portfolio-hover">
											
											<a class="portfolio-zoom prettyPhoto" href="images1/<?php echo $imm2;?>"><i class="fa fa-search"></i></a>
										</div>
									</div><!-- End portfolio-head -->
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="diploma.php"><?php echo $sub2;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									<div class="portfolio-head">
										<div class="portfolio-img"><img alt="" src="images1/<?php echo $imm3;?>"></div>
										<div class="portfolio-hover">
											
											<a class="portfolio-zoom prettyPhoto" href="images1/<?php echo $imm3;?>"><i class="fa fa-search"></i></a>
										</div>
									</div><!-- End portfolio-head -->
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="mba.php"><?php echo $sub3;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									<div class="portfolio-head">
										<div class="portfolio-img"><img alt="" src="images1/<?php echo $imm4;?>"></div>
										<div class="portfolio-hover">
											
											<a class="portfolio-zoom prettyPhoto" href="images1/<?php echo $imm4;?>"><i class="fa fa-search"></i></a>
										</div>
									</div><!-- End portfolio-head -->
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="others.php"><?php echo $sub4;?></a></h6></div>
	...
	<div class="sections sections-padding-b-50">
		<div class="container">
			<div class="sections-title">
				<div class="sections-title-h3"><h3><?php echo $t10;?></h3></div>
