<?php
include "link.php";
$sel=mysqli_query($link,"select * from ce where id='1'");
...
$sel=mysqli_query($link,"select * from ce where id='2'");
while($arr=mysqli_fetch_array($sel))
{
					...
					<div class="pricing-tables" >
						...
						<div class="pricing-content" >
							<ul style="font-size:10px!important">
								...
								<li><strong><?php echo $txt1;?></strong><span><?php echo $txt2;?></span><span><?php echo $txt3;?></span></li>
