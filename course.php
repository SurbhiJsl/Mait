								...
								<div class="portfolio-one">
									...
									<div class="portfolio-content">
										...
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="btech.php"><?php echo $s1;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									...
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="diploma.php"><?php echo $s2;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									...
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="mba.php"><?php echo $s3;?></a></h6></div>
							...
							<div class="col-md-3 portfolio-item">
								<div class="portfolio-one">
									...
									<div class="portfolio-content">
										<i class="fa fa-leaf"></i>
										<div class="portfolio-meta">
											<div class="portfolio-name"><h6><a href="others.php"><?php echo $s4;?></a></h6></div>
