<?php
include "link.php";
$sel=mysqli_query($link,"select * from btech where id='1'");
					...
					<div class="pricing-tables" >
						...
						<div class="pricing-content" >
							<ul style="font-size:10px!important">
								<li><a href="cse.php"><strong><?php echo $tx1;?></strong></a></li>
								<li><a href="it1.php"><strong><?php echo $tx2;?></strong></a></li>
								<li><a href="ece1.php"><strong><?php echo $tx3;?></strong></a></li>
								<li><a href="ce1.php"><strong><?php echo $tx4;?></strong></a></li>
								<li><a href="me1.php"><strong><?php echo $tx5;?></strong></a></li>
