<?php
include "link.php";
$sel=mysqli_query($link,"select * from it where id='1'");
...
$sel=mysqli_query($link,"select * from it where id='2'");
while($arr=mysqli_fetch_array($sel))
{
	$t2=$arr['title'];
	$tx2=$arr['text'];
...
$sel=mysqli_query($link,"select * from it where id='3'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='4'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='5'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='6'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='7'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='8'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from it where id='9'");
while($arr=mysqli_fetch_array($sel))
{
