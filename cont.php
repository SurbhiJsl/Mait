...
if(isset($sub))
{
	if(mysqli_query($link,"insert into contact values('$name','$email','$message')"))
	{
...
$sel=mysqli_query($link,"select * from contact where id='2'");
		...
		<div class="container clearfix">
			...
			<nav class="navigation">
				<ul>
					...
					<li class="current_page_item"><a href="cont.php"><?php echo $title7;?></a></li>
				</ul>
			</nav><!-- End navigation -->
		</div><!-- End container -->
	</header><!-- End header -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 main-content">
					...
					<div class="row">
						<div class="col-md-9">
							<div class="section-title section-title-2 section-title-3"><h6><?php echo $t1;?></h6></div>
							<div class="comment-form">
								<form method="post" action="">
									<div class="row">
										...
										<div class="col-md-12">
											<input type="submit" class="button-3" value="Send Message" name="sub">
										</div>
									</div><!-- End row -->
								</form>
						...
						<div class="col-md-3">
							<div class="section-title section-title-2 section-title-3"><h6><?php echo $s1;?></h6></div>
							<div class="contact-information">
								<ul>
									<li><?php echo $tx1;?></li>
									<li><?php echo $i1;?><p>
</p><p><?php echo $i2;?></p><p></p>
<?php echo $i3;?></li>
									<li><?php echo $i4;?></li>
								</ul>
