<?php
include "link.php";
$sel=mysqli_query($link,"select * from others where id='1'");
   ...
   <div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="../index.php">Home</a><span class="crumbs-span">&raquo;</span><span>others</span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
					...
					<div class="pricing-tables" >
						...
						<div class="pricing-content" >
							<ul style="font-size:10px!important">
								<li><a href="others.php"><strong><?php echo $tx1;?></strong></a></li>
								<li><a href="others.php"><strong><?php echo $tx2;?></strong></a></li>
