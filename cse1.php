<?php
include "link.php";
$sel=mysqli_query($link,"select * from cse where id='1'");
...
$sel=mysqli_query($link,"select * from cse where id='2'");
while($arr=mysqli_fetch_array($sel))
{
	$t2=$arr['title'];
	$tx2=$arr['text'];
...
$sel=mysqli_query($link,"select * from cse where id='3'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='4'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='5'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='6'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='7'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='8'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from cse where id='9'");
while($arr=mysqli_fetch_array($sel))
{
   ...
   <div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="index.php">Home</a><span class="crumbs-span">&raquo;</span><span>Computer Science & Engineering</span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
					...
					<div class="pricing-tables" >
						...
						<div class="pricing-content" >
							<ul style="font-size:10px!important">
								<li><strong><?php echo $tx2;?></strong><span><?php echo $tx3;?></span><span><?php echo $tx4;?></span></li>
