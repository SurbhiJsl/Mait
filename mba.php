<?php
include "link.php";
$sel=mysqli_query($link,"select * from mba where id='1'");
   ...
   <div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="index.php">Home</a><span class="crumbs-span">&raquo;</span><span>mba</span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
	...
	<div class="sections">
		<div class="container">
			...
			<div class="row" >
				<div class="col-md-3 pricing-item" style="width:33%!important; margin-left:30%; ">
					<div class="pricing-tables" >
						...
						<div class="pricing-content" >
							<ul style="font-size:10px!important">
								<li><a href="#"><strong><?php echo $tx1;?></strong></a></li>
								<li><a href="#"><strong><?php echo $tx2;?></strong></a></li>
								<li><a href="#"><strong><?php echo $tx3;?></strong></a></li>
								<li><a href="#"><strong><?php echo $tx4;?></strong></a></li>
