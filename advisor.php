<?php
include "link.php";
$sel=mysqli_query($link,"select * from advisor where id='1'");
...
$sel=mysqli_query($link,"select * from advisor where id='2'");
while($arr=mysqli_fetch_array($sel))
{
			...
			<div class="tp-banner">
				<ul>
					<li data-transition="random" data-slotamount="7" data-masterspeed="1500">
						<!-- MAIN IMAGE -->
						<img src="images1/<?php echo $i2;?>" alt="" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
						...
						<div class="slide-p tp-caption black randomrotate skewtoleft tp-resizeme start" 
							...
							data-endspeed="500" style="z-index: 6;white-space: pre-line;max-width: 1170px;text-align: center;"><h2><?php echo $tx1;?></h2>
                    <p><?php echo $i1;?></p>
						</div>
	...
	<div class="sections">
		<div class="container">
			<div class="sections-title">
				<div class="sections-title-h3"><h2><?php echo $s1;?></h2></div>
				 
            <p style="text-align:justify"><?php echo $tx2;?>
       
			</p>
			<p style="text-align:right"><?php echo $i3;?></p>
			<p style="text-align:right"><?php echo $i4;?></p>
			<p style="text-align:right"><?php echo $i5;?>
			</p>
