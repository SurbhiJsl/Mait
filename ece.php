<?php
include "link.php";
$sel=mysqli_query($link,"select * from ece where id='1'");
...
$sel=mysqli_query($link,"select * from ece where id='2'");
while($arr=mysqli_fetch_array($sel))
{
	$t2=$arr['title'];
	$tx2=$arr['text'];
...
$sel=mysqli_query($link,"select * from ece where id='3'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from ece where id='4'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from ece where id='5'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from ece where id='6'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from ece where id='7'");
while($arr=mysqli_fetch_array($sel))
{
...
$sel=mysqli_query($link,"select * from ece where id='8'");
while($arr=mysqli_fetch_array($sel))
{
...
<p align="right"><?php echo $txt1;?><br>
