<?php
include "link.php";
$sel=mysqli_query($link,"select * from manage where id='1'");
    ...
    <div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="index.php">Home</a><span class="crumbs-span">&raquo;</span><span>management</span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
								...
								<img src="images1/<?php echo $i1;?>" width="100%" height="200">
